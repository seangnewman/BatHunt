...
window.onload = function()
{
     ...
     */
    queue.loadManifest([
        {id: 'backgroundImage', src: './resources/images/background.png'},
        {id: 'crossHair', src: './resources/images/crosshair.png'},
        {id: 'shot', src: './resources/audio/shot.mp3'},
        {id: 'background', src: './resources/audio/countryside.mp3'},
        {id: 'gameOverSound', src: './resources/audio/gameOver.mp3'},
        {id: 'tick', src: './resources/audio/tick.mp3'},
        {id: 'deathSound', src: './resources/audio/die.mp3'},
        {id: 'batSpritesheet', src: './resources/images/batSpritesheet.png'},
        {id: 'batDeath', src: './resources/images/batDeath.png'},
    ]);
    queue.load();
